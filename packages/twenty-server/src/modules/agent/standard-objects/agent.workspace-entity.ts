...
@WorkspaceEntity({
  ...
  labelIdentifierStandardId: AGENT_STANDARD_FIELD_IDS.name,
})
...
export class AgentWorkspaceEntity extends BaseWorkspaceEntity {
  ...
  @WorkspaceField({
    standardId: AGENT_STANDARD_FIELD_IDS.stage,
  ...
  @WorkspaceField({
    standardId: AGENT_STANDARD_FIELD_IDS.position,
  ...
  @WorkspaceField({
    standardId: AGENT_STANDARD_FIELD_IDS.createdBy,
